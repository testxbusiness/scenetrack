    ...
    try {
      ...
      if (step === 'script' && selectedFile) {
        try {
          ...
          console.log('Parsed scenes from PDF:', scenes)
          console.log('Extracted cast members:', allCastMembers)
          ...
          if (allCastMembers.length > 0) {
            ...
            console.log('Inserted cast members:', insertedCastMembers);
      ...
      if (error instanceof Error) {
        ...
        // If it's a Supabase error, show specific details
        if ('code' in error) {
